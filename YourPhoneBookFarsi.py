...
God_Label = Label(win, text='نیروی اندیشیدن نیروی خداست @', background='White')
God_Label.place(x=1085, y=0)

lb = Label(win, text=': نام', font=5)
lb.place(x=900, y=40)

en = Entry(win , width = 60, bd = 3, font=('Arial', 15) )
en.place(x = 225, y = 42)

lb1 = Label(win, text=': نام خانوادگی', font=5)
lb1.place(x=835, y=90)

en1 = Entry(win , width = 60 , bd = 3, font=('Arial', 15) )
en1.place(x=160 , y=93)

lb2 = Label(win, text=': شماره تماس', font=5)
lb2.place(x=840, y=195)

en2 = Entry(win , width = 60 , bd = 3, font=('Arial', 15) )
en2.place(x = 160 , y = 195)

lb3 = Label(win, text=': آدرس', font=5)
...
btn = Button(win, text='ذخیره', padx=50, pady=10, font=20, background='pink', command=savebtn)
...
def clear_edit_btn():
    ...
    def deletefunc():
        ...
        lb = Label(top2, text=': نامی را که می خواهید حذف کنید وارد نمایید', font=5, background='Pink')
        lb.place(x=175, y=10)

        en = Entry(top2, width = 43, bd = 3, font=('Arial', 15))
        en.place(x=10, y=50)

        lb1 = Label(top2, text=': نام خانوادگی را که می خواهید حذف کنید وارد نمایید', font=5, background='Pink')
        ...
        def deletebtn():
            ...
            for record_of_loop in list_of_records:
                ...
                if record_of_loop[0] == en.get() and record_of_loop[1] == en1.get():
                    ...
                    messagebox.showerror("خطا" , "! نام ونام خانوادگی موجد نیست") 
                    top2.destroy()  
            

        deletebutton = Button(top2, text='حــــــــــذف', command=deletebtn, width=30, height=1, bd=3, background='Pink', font='Bold')
    ...
    def editfunc():
        ...
        lb50 = Label(top3, text=': نامی را که می خواهید ویرایش کنید وارد نمایید', font=5, background='Pink')
        lb50.place(x=410, y=10)

        en50 = Entry(top3, width = 65, bd = 3, font=('Arial', 15))
        en50.place(x=15, y=50)

        lb51 = Label(top3, text=': نام خانوادگی را که می خواهید ویرایش کنید وارد نمایید', font=5, background='Pink')
        ...
        def editfunc1():
            ...
            for record_of_loop1 in list_of_records1:
                ...
                if record_of_loop1[0] == en50.get() and record_of_loop1[1] == en51.get():
                    ...
                    lb100 = Label(top4, text=': تـــــغــیـیرات خـود را اعـــمال کنید', font=0, background='Pink')
                    ...
                    label = Label(top4, text='توجه : اگر می خواهید نام را تغییر دهید آن را به تنهایی تغییر دهید و بقیه را با هم', font=0, background='Pink')
            ...
            editbutton1 = Button(top4, text='...   بروزرسانی', command=editfunc2, width=59, height=2, bd=3, background='Pink', font='Bold')
        ...
        editbutton = Button(top3, text='برای ویرایش کلیک کنید', command=editfunc1, width=59, height=2, bd=3, background='Pink', font='Bold')

        editbutton.place(x=50, y=220)
    

    deletebutton = Button(top1, text='حــــــــــذف', command=deletefunc, width=61, height=2, bd=3, background='Pink', font='Bold')

    deletebutton.place(x=2, y=3)

    editbutton = Button(top1, text='ویــــــــــرایش', command=editfunc, width=61, height=2, bd=3, background='Pink', font='Bold')

    editbutton.place(x=698, y=3)



    lbl100 = Label(second_frame, text='آدرس', font=('Bold', 18), background='Blue')
    lbl100.grid(row=1, column=150, padx=300, pady=10)

    lbl200 = Label(second_frame, text='شماره تماس', font=('Bold', 18), background='Blue')
    lbl200.grid(row=1, column=200, padx=70, pady=10)

    lbl300 = Label(second_frame, text='نام خانوادگی', font=('Bold', 18), background='Blue')
    lbl300.grid(row=1, column=250, padx=70, pady=10)

    lbl400 = Label(second_frame, text='نـام', font=('Bold', 18), background='Blue')
...
btn1 = Button(win, text='لیست ، ویرایش و حذف', padx=50, pady=10, font=20, background='pink', command=clear_edit_btn)
btn1.place(x= 300, y=350)




lb4 = Label(win, text=': جستجوی دفتر تلفن', font=5, background='Red')
lb4.place(x=800, y=460)

lb5 = Label(win, text=': نام را وارد نمایید', font=5)
lb5.place(x=810, y=510)

en4 = Entry(win , width = 55, bd = 4, font=('Arial', 15))
en4.place(x = 180 , y = 510)

lb6 = Label(win, text=': نام خانوادگی را وارد نمایید', font=5)
...
btn2 = Button(win, text='جستجو', padx=200, pady=1, font=20, background='pink', command=searchbtn)
